  ...
  return (
    <footer className="border-t-[3px] border-black bg-black">
      <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 md:flex-row md:items-center md:justify-between">
        <div className="text-xs font-black uppercase tracking-[0.14em] text-[#f4ecd6]">
          {FOOTER_TEXT}
        </div>
        <div className="bg-red-700 px-3 py-1 text-xs font-black uppercase tracking-[0.14em] text-[#f4ecd6]">
          {FOOTER_SLOGAN}
        </div>
      </div>
    </footer>
